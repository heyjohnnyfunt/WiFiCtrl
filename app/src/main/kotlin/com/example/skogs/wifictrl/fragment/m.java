...
/**
 * Created by skogs on 06.06.2016.
 */
...
public class m extends VpnService implements Handler.Callback, Runnable {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        mSharedSecret = /*intent.getStringExtra(prefix + ".SECRET")*/".SECRET".getBytes();
    ...
    public synchronized void run() {
        try {
            ...
            InetSocketAddress server = new InetSocketAddress("127.0.0.1", 8087
